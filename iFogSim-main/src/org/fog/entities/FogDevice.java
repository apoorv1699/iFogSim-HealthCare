...
public class FogDevice extends PowerDatacenter {
    ...
    private double totalDataSent = 0.0;
    private double totalDataReceived = 0.0;
	...
	public void updateProcessingTime(double processingTime) {
        this.totalProcessingTime += processingTime;
    }

    public void updateDataSent(double dataSent) {
        this.totalDataSent += dataSent;
    }

    public void updateDataReceived(double dataReceived) {
        this.totalDataReceived += dataReceived;
    }
